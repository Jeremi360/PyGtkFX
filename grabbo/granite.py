...
from gi.repository.Granite import WidgetsCellRendererBadge as CellRendererBadge
from gi.repository.Granite import WidgetsCellRendererExpander as CellRendererExpander
